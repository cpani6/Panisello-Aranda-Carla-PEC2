...
legend("topright",  inset = c(-0.3, 0), legend = levels(age_factor), fill = colors_age, title = "Age",bty = "n")
legend("bottomright",  inset = c(-0.3, 0), legend = levels(factor(group)), pch = unique(pch[group]), title = "Cohort",bty = "n")


boxplot(age ~ cohort, data = colData(Covid_75), col=colors_age)
